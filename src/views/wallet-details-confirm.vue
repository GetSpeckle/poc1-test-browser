  ...
  div
    v-container(fluid, v-if="!processing")
      ...
      v-layout.mt-5(row, wrap)
        v-flex.px-1(xs6)
          v-btn(block, color="success", dark, large, @click="confirmSendWalletDetails") {{ $t( 'general.confirmSend' ) }}
        v-flex.px-1(xs6)
